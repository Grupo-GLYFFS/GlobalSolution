  ...
  return `
    <div class="satellite-card bg-white border border-gray-200 rounded-xl overflow-hidden ${extraClasses}">
      ...
      <div class="p-4 flex-1 flex flex-col">
        <div class="text-xs font-medium text-gray-400 uppercase tracking-caps">${satellite.category}</div>
        <h3 class="text-base font-bold tracking-heading text-gray-900 mt-1 leading-none"><a href="${basePath}/pages/satellite.html?id=${satellite.id}" class="hover:underline">${satellite.name}</a></h3>
